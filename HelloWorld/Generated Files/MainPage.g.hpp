...
void ::HelloWorld::MainPage::Connect(int __connectionId, ::Platform::Object^ __target)
{
        ...
        case 5:
            {
                ...
                (safe_cast<::Windows::UI::Xaml::Controls::Button^>(this->inputButton))->Click += ref new ::Windows::UI::Xaml::RoutedEventHandler(this, (void (::HelloWorld::MainPage::*)
...
::Windows::UI::Xaml::Markup::IComponentConnector^ ::HelloWorld::MainPage::GetBindingConnector(int __connectionId, ::Platform::Object^ __target)
{
